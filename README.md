# Simple world simulation in Python
The project implements a virtual world simulator, which has simple life forms with different behavior. The user can participate in world simulation, being a "Human" organism. The aim of project was to exercise OOP in Python. The graphical interface was made using Tkinter.
...
# Features
- World rendering and windows supported by *Tkinter* library.
...
- New kind of animal absent in other implementations: Cybersheep.

# Run
```
git clone https://github.com/axinterop/simple-world-sim-py.git
cd simple-world-sim-java
python run
```

# Screenshot
![simulation](showcasepy.png)
